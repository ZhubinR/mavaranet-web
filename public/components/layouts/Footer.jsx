        ...
        <div className="row">
          <div className="col-xl-4 col-lg-6 mb-5 mb-xl-0">
            <div className="footer_contact">
              ...
              <p className="desc">
                جهت دنبال کردن آخرین اخبار و مقالات، فعالیت های مجموعه و برقراری
                ارتباط با تیم مارکتینگ از راه های ارتباطی زیر استفاده کنید.
              </p>
              ...
              <p className="desc">ماورانت در شبکه های اجتماعی</p>
          ...
          <div className="col-xl-4 col-lg-6 mb-5 mb-xl-0">
            <div className="footer_about px-xl-3">
              ...
              <p className="desc">
                ماورانت، به عنوان اولین و بزرگترین آژانس IT-Medical کشور، در
                زمینه برندینگ، با داشتن ۱۸۰ کارشناس حرفه ای، جهت دیده شدن تخصص،
                فلوشیپ و فوق تخصص پزشکان و همچنین خدمات مراکز درمانی فعالیت
                می‌کند. همکاری با ۱۳۰ استاد در حوزه‌های درمانی و زیبایی، ۸ انجمن
                پزشکی، ۵ مرکز تحقیقات و بیش از ۱۴۰۰ پروژه درمانی در طول ۱۵ سال
                فعالیت، گویای اعتماد مثال زدنی است که جامعه درمانی کشور به
                ماورانت دارد. تحقق نقش پررنگ و اثر گذار ما در تسهیل درمان
                بیماران (بخصوص بیماران VIP و IPD) به دست برترین متخصصان کشور،
                همیشه اصلی ترین انگیزه در مسیر چشم انداز ماورانت است.
              </p>
            </div>
          </div>
