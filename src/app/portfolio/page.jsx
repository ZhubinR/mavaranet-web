  ...
  const Filter = (category) => {
    if (category === selectedCategory) {
      ...
      const filtered = portfolioData.filter(
        (item) => item.acf.catergory.name === category
      );
        ...
        <div className="filter-row py-3">
          ...
          <button
            className={`filter-btn ${
              selectedCategory === "طراحی سایت" ? "active" : ""
            }`}
            onClick={() => Filter("طراحی سایت")}
          >
            طراحی سایت
          </button>
          ...
          <button
            className={`filter-btn ${
              selectedCategory === "سئو و محتوا" ? "active" : ""
            }`}
            onClick={() => Filter("سئو و محتوا")}
          >
            سئو و محتوا
          </button>
